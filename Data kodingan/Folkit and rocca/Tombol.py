...
game_dino = pygame.image.load('Folkit and rocca/Gambarrr/rakun_idle.png')
...
game_beruang = pygame.image.load('Folkit and rocca/Gambarrr/rubah_idle.png')
beruang_game = Button(200,560,game_beruang,1.5)

#Tombol Start
button_start = pygame.image.load('Folkit and rocca/Gambarrr/tombol/button_start.png')
start_button = Button(480,450,button_start,0.8)

#Tombol How to play
how_to = pygame.image.load('Folkit and rocca/Gambarrr/tombol/howtoplay_button.png')
button_how_to = Button(480,530,how_to,0.15)

#Tombol Credits
credits = pygame.image.load('Folkit and rocca/Gambarrr/tombol/CREDITS.png')
button_credits = Button(480,610,credits,0.18)

#Tombol Exit
button_end = pygame.image.load('Folkit and rocca/Gambarrr/tombol/exitt.png')
end_button = Button(480,690,button_end,0.8)

#PILIHAN KETIKA GAME OVER
#Tombol Play Again
gameover_button = pygame.image.load('Folkit and rocca/Gambarrr/tombol/PlayAgain.png')
button_gameover = Button(480,600,gameover_button,0.18)

#Tombol Exit
gameover_button_exit = pygame.image.load('Folkit and rocca/Gambarrr/tombol/button_exit.png')
button_gameover_exit = Button(480,680,gameover_button_exit,0.18)

#Gambar Dino mati
gameover = pygame.image.load('Folkit and rocca/Gambarrr/Background/gameover.png')
